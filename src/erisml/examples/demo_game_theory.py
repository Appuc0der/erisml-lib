...
def demo_strategic_layer():
    ...
    # (Alice, Bob) rewards
    payoffs[0, 0, 0] = 3; payoffs[1, 0, 0] = 3  # Coop/Coop (Reward)
    payoffs[0, 0, 1] = 0; payoffs[1, 0, 1] = 5  # Coop/Defect (Sucker/Temptation)
    payoffs[0, 1, 0] = 5; payoffs[1, 1, 0] = 0  # Defect/Coop (Temptation/Sucker)
    payoffs[0, 1, 1] = 1; payoffs[1, 1, 1] = 1  # Defect/Defect (Punishment)
