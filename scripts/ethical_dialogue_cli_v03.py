#!/usr/bin/env python
"""
ethical_dialogue_cli_v03.py

Interactive, YAML-driven DEME ethics dialogue that builds a DEMEProfileV03.

This is a refinement of v02 that adds:
  - lexical_layers: a hierarchy of principle clusters
  - override_graph: a small DAG of context-sensitive overrides
"""
...
# ---------------------------------------------------------------------------
# Dialogue pieces (mostly same as v02)
# ---------------------------------------------------------------------------
...
def main() -> None:
    ...
    print()
    print("=" * 72)
    print(f"DEMEProfileV03 written to: {args.output}")
